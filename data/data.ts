import homeHeaderImage from '../public/images/headerImage.gif'
...
export const aboutUsPageData = {
  ...
  description: `weDoAll is one online technology solutions provider company that is
  considered as a new breed of thinkers who is driven to create
  effective business solutions for its clients. We aspire to become
  our client’s first choice when it comes to being a world leader in
  the progress and advancement of businesses through digital
...
export const bannerCardData = {
  ...
  aboutUsDescription:
    'weDoAll. is the Official US Partner of odoo and we strive to provide cutting-edge solutions tailored to elevate your business operations',
  images: [
    {
      img: bannerP1,
      className: 'img-p1',
  ...
  partnersCard: [
    {
      ...
      description:
        'weDoAll transforms your business needs into seamless Odoo implementations, optimizing processes for sustained growth.',
      img: bannerP6,
    },
    {
      title: 'Odoo Custom Development',
      description:
        'weDoAll crafts tailored Odoo solutions, seamlessly integrating custom features for a unified and efficient platform',
      img: bannerP6,
    },
  ],
}
...
export const footerData = {
  copyright: `weDoAll © ${new Date().getFullYear()}. All Rights Reserved`,
  details: [
    {
      icon: LocationIcon,
      desc: 'Vikas Nagar , Lucknow,UP - India ',
    },
    {
      icon: PhoneIcon,
      desc: '+91 6394633848',
